...
點擊頁面右上角的綠色 **Code** 按鈕 → **Download ZIP**，解壓縮後進入 **`windows/`** 資料夾。
...
4. Double-click `start.bat` — first run auto-installs all dependencies **and FFmpeg**
